...
# Import data -------------------------------------------------------------
for (i in 2010:2021) {
  HCRIS.alpha=read_csv(paste0("C:/Users/phadmin/Desktop/econ 771/e1/HCRIS_v2010/HospitalFY",i,"/hosp10_",i,"_ALPHA.CSV"),
                       col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.numeric=read_csv(paste0("C:/Users/phadmin/Desktop/econ 771/e1/HCRIS_v2010/HospitalFY",i,"/hosp10_",i,"_NMRC.CSV"),
                         col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.report=read_csv(paste0("C:/Users/phadmin/Desktop/econ 771/e1/HCRIS_v2010/HospitalFY",i,"/hosp10_",i,"_RPT.CSV"),
...
write_tsv(final.hcris.v2010,'C:/Users/phadmin/Desktop/econ 771/e1/HCRIS_Data_v2010.txt',append=FALSE,col_names=TRUE)
