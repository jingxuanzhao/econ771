...
for (i in 1998:2011) {
  HCRIS.alpha=read_csv(paste0("C:/Users/phadmin/Desktop/econ 771/e1/HCRIS_v1996/HospitalFY",i,"/hosp_",i,"_ALPHA.CSV"),
                       col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.numeric=read_csv(paste0("C:/Users/phadmin/Desktop/econ 771/e1/HCRIS_v1996/HospitalFY",i,"/hosp_",i,"_NMRC.CSV"),
                         col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.report=read_csv(paste0("C:/Users/phadmin/Desktop/econ 771/e1/HCRIS_v1996/HospitalFY",i,"/hosp_",i,"_RPT.CSV"),
...
write_tsv(final.hcris.v1996,'C:/Users/phadmin/Desktop/econ 771/e1/HCRIS_Data_v1996.txt',append=FALSE,col_names=TRUE)
